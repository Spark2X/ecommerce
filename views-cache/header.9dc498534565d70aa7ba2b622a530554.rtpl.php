...
<head>
  ...
  <title>Só os crias, segura😎😎😎</title>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- Task item -->
                    <a href="#">
                      <!-- Task title and prog/ress text -->
                      <h3>
                        Design some buttons
                        <small class="pull-right">20%</small>
                      </h3>
                      <!-- The prog/ress bar -->
                      <div class="prog/ress xs">
                        <!-- Change the css width attribute to simulate prog/ress -->
                        <div class="prog/ress-bar prog/ress-bar-aqua" style="width: 20%" role="prog/ressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
