                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="/profile"><i class="fa fa-user"></i> -----------="getUserName()"}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt">R$-----------="getCartVlSubTotal()"}</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">-----------="getCartNrQtd()"}</span></a>
                    </div>
                </div>
            </div>
        </div>
